...
![基线 — Output-only / Random / Trained](docs/figures/fig1_baselines.png)
...
![IAS 扫描 — 通道掩码比例 vs loss](docs/figures/fig2_ias_sweep.png)
...
![Mode collapse — 输出坐标频度](docs/figures/fig5_mode_collapse.png)
...
![Loss 分解 — 95% 先验 + 5% 棋盘信号](docs/figures/fig4_loss_decomposition.png)
