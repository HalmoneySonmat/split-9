...
![ベースライン — Output-only / Random / Trained](runs/figures/fig1.png)
...
![IAS スイープ — チャネルマスク率 vs loss](runs/figures/fig2.png)
...
![Mode collapse — 出力座標の頻度](runs/figures/fig5.png)
...
![Loss 分解 — 95% 事前分布 + 5% 盤面信号](runs/figures/fig4_loss_decomposition.png)
