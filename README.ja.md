...
![ベースライン — Output-only / Random / Trained](docs/figures/fig1_baselines.png)
...
![IAS スイープ — チャネルマスク率 vs loss](docs/figures/fig2_ias_sweep.png)
...
![Mode collapse — 出力座標の頻度](docs/figures/fig5_mode_collapse.png)
...
![Loss 分解 — 95% 事前分布 + 5% 盤面信号](docs/figures/fig4_loss_decomposition.png)
