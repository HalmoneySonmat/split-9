...
![베이스라인 비교 (Output-only / Random / Trained)](docs/figures/fig1_baselines.png)
...
![IAS sweep — 채널 마스크 비율에 따른 loss](docs/figures/fig2_ias_sweep.png)
...
![Mode collapse — 출력 좌표 빈도](docs/figures/fig5_mode_collapse.png)
...
![Loss 분해 — 95% prior + 5% per-board](docs/figures/fig4_loss_decomposition.png)
